...
# =============================================================================
    ...
    if st.checkbox('Zijn er eenmalige taken die niet in de data omschreven zijn?'):
        ...
        for i in range(int(aantal_taken)):
            speciale_taak = st.text_input("Hoe heet de taak die toegevoegd moet worden?")
    ...
    grid_return4 = AgGrid(new_df2[['Taken','Aantal']][new_df2['Aan']==1], editable=True, fit_columns_on_grid_load=True,height = len(new_df2[['Taken','Aantal']][new_df2['Aan']==1])*30 + 30)
